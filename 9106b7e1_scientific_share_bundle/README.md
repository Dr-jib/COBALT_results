...
flight animations, and one representative waypoint summary for **CYYC -> CYXU**.

Scenario ID from COBALT: `9106b7e1-695d-4dde-8a60-e327ab341522`  
...
- `data/9106b7e1-695d-4dde-8a60-e327ab341522_multicon_science.nc` — CF-1.11 NetCDF scientific dataset (144 waypoints).
- `animations/` — IWC, number concentration, optical depth, signed settling
  velocity, effective radius, and shape-index GIFs.
- `snapshot/row_0027_scientific_summary.png` — row 27 summary.
...
```python
import xarray as xr
ds = xr.open_dataset("data/9106b7e1-695d-4dde-8a60-e327ab341522_multicon_science.nc", engine="h5netcdf")
print(ds)
```

MATLAB: `ncdisp('data/9106b7e1-695d-4dde-8a60-e327ab341522_multicon_science.nc')`  
R: `ncdf4::nc_open('data/9106b7e1-695d-4dde-8a60-e327ab341522_multicon_science.nc')`
