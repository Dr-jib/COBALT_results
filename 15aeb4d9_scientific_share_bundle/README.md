...
flight animations, and one representative waypoint summary for **CYQQ -> CYEG**.

Scenario ID from COBALT: `15aeb4d9-365f-40aa-a20e-5b7e0f7e31b1`  
...
- `data/15aeb4d9-365f-40aa-a20e-5b7e0f7e31b1_multicon_science.nc` — CF-1.11 NetCDF scientific dataset (39 waypoints).
- `animations/` — IWC, number concentration, optical depth, signed settling
  velocity, effective radius, and shape-index GIFs.
- `snapshot/row_0031_scientific_summary.png` — row 31 summary.
...
```python
import xarray as xr
ds = xr.open_dataset("data/15aeb4d9-365f-40aa-a20e-5b7e0f7e31b1_multicon_science.nc", engine="h5netcdf")
print(ds)
```

MATLAB: `ncdisp('data/15aeb4d9-365f-40aa-a20e-5b7e0f7e31b1_multicon_science.nc')`  
R: `ncdf4::nc_open('data/15aeb4d9-365f-40aa-a20e-5b7e0f7e31b1_multicon_science.nc')`
