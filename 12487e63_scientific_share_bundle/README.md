...
flight animations, and one representative waypoint summary for **EPWA -> EGGW**.

Scenario ID from COBALT: `12487e63-b955-41c6-9cfa-ad46fcc54131`  
...
- `data/12487e63-b955-41c6-9cfa-ad46fcc54131_multicon_science.nc` — CF-1.11 NetCDF scientific dataset (83 waypoints).
- `animations/` — IWC, number concentration, optical depth, signed settling
  velocity, effective radius, and shape-index GIFs.
- `snapshot/row_0020_scientific_summary.png` — row 20 summary.
...
```python
import xarray as xr
ds = xr.open_dataset("data/12487e63-b955-41c6-9cfa-ad46fcc54131_multicon_science.nc", engine="h5netcdf")
print(ds)
```

MATLAB: `ncdisp('data/12487e63-b955-41c6-9cfa-ad46fcc54131_multicon_science.nc')`  
R: `ncdf4::nc_open('data/12487e63-b955-41c6-9cfa-ad46fcc54131_multicon_science.nc')`
