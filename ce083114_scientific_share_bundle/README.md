...
flight animations, and one representative waypoint summary for **GMAD -> EGPF**.

Scenario ID from COBALT: `ce083114-bd8e-44f7-b9e3-2e5ef3de9ef4`  
...
- `data/ce083114-bd8e-44f7-b9e3-2e5ef3de9ef4_multicon_science.nc` — CF-1.11 NetCDF scientific dataset (186 waypoints).
- `animations/` — IWC, number concentration, optical depth, signed settling
  velocity, effective radius, and shape-index GIFs.
- `snapshot/row_0182_scientific_summary.png` — row 182 summary.
...
```python
import xarray as xr
ds = xr.open_dataset("data/ce083114-bd8e-44f7-b9e3-2e5ef3de9ef4_multicon_science.nc", engine="h5netcdf")
print(ds)
```

MATLAB: `ncdisp('data/ce083114-bd8e-44f7-b9e3-2e5ef3de9ef4_multicon_science.nc')`  
R: `ncdf4::nc_open('data/ce083114-bd8e-44f7-b9e3-2e5ef3de9ef4_multicon_science.nc')`
